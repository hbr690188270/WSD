...
def add_word(word,vocab_list,word_candidate,id_to_sem,word_sem,word_pos):
    ...
    for sub_word in vocab_list:
        ...
        for pos in common_pos:
            ...
            # orig_sem_list = word_sem[word][pos]
            # sub_sem_list = word_sem[sub_word][pos]
            
            # if compare_list(orig_sem_list, sub_sem_list):
                # word_candidate[word][pos].append(sub_word)
...
if __name__ == '__main__':
    ...
    # with open("aux_files/word_sem.pkl",'wb') as f:
    #     pickle.dump(word_sem,f)
    # with open("aux_files/word_pos.pkl",'wb') as f:
